...
```bash
# 基本出力
python test_stat_cli.py -o results.csv sample1.xlsx
# → results.csv

# 日付フィルタ
python test_stat_cli.py -o results.csv --date-range 2024-01-15 2024-01-20 sample1.xlsx
# → results_2024-01-15_to_2024-01-20.csv

# 複合フィルタ
python test_stat_cli.py -o results.csv --date-range 2024-01-15 2024-01-20 --tester テスト太郎 sample1.xlsx
# → results_2024-01-15_to_2024-01-20_テスト太郎.csv
```
