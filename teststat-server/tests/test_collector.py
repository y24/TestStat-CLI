...
from app.services.collector import CollectTarget, build_list_yaml, count_collect_targets, _load_targets  # noqa: E402
    ...
    def test_build_list_yaml(self):
        yaml_text = build_list_yaml(
            CollectTarget(
                ...
                files=(("LABEL1", "https://contoso.sharepoint.com/:x:/s/a?x=1"),),
            )
        )
