...
from sqlalchemy import Boolean, Date, DateTime, ForeignKey, Index, Integer, JSON, String, UniqueConstraint, false, func, true
...
class PlanLabel(Base):
    ...
    use_plan_as_actual_offset: Mapped[bool] = mapped_column(
